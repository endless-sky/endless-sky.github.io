...
Another long-standing request is to have more starts available to the game, which Anarchist has provided us with! In addition to the default one currently in the game, there are now three more human starts for a little more variance - start richer, start with less, or start with something a bit different than what we have now. Which you choose is up to you!
...
If you're a lore fanatic, there are now a few new hidden culture conversations around the galaxy thanks to Arachi. Should you come across one, you may gain a little insight into some of the galaxy's alien races and historical events.
